...
public class WebDavServletBean extends HttpServlet {
	...
	private static TreeManagerWSService service = new TreeManagerWSService();
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
        	...
        	if(sessionKey == null || service.getTreeManagerPort().authenticateWithSessionKey(UUID.fromString(sessionKey)) == null)
